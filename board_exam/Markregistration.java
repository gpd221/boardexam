...
public class Markregistration {
	 ...
	 */
	 public Markregistration(Connection con) {
	        this.con = con;
	        initialize();
	 }
	...
	private void initialize() {
		...
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	                ...
	                String Hindi = textField_5.getText();
	                String Malayalam = textField_6.getText();

	                try {


	                	PreparedStatement preparedStatement = con.prepareStatement("insert into Marks (Student_id, Maths,Social,Science,English, Hindi, Malayalam) values (?,?,?,?,?,?,?);");
	                    preparedStatement.setString(1, Student_id);
	                    preparedStatement.setString(2, Maths);
	                    preparedStatement.setString(3,Social);
	                    preparedStatement.setString(4, Science);
	                    preparedStatement.setString(5,English);
	                    preparedStatement.setString(6,Hindi);
	                    preparedStatement.setString(7, Malayalam);
