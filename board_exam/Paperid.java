...
Connection con;
	...
	private void initialize() {
		...
		lblMarkRegistration.setBounds(367, 10, 432, 91);
		...
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Markregistration markobj = new Markregistration(con);
		...
		lblNewLabel_1.setBounds(-11, 0, 925, 513);
		...
		btnNewButton_3_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                String Maths_Id = textField_1.getText();
                String Social_Id = textField_2.getText();
                String Science_Id = textField_3.getText();
                String English_Id = textField_4.getText();
                String Hindi_Id = textField_5.getText();
                String Malayalam_Id = textField_6.getText();

                try {


                	PreparedStatement preparedStatement = con.prepareStatement("insert into Paper (Student_id,Maths_Id,Social_Id,Science_Id,English_Id,Hindi_Id,Malayalam_Id) values (?,?,?,?,?,?,?);");
                	preparedStatement.setString(1, Student_Id);
                    preparedStatement.setString(2,Maths_Id);
                    preparedStatement.setString(3,Social_Id);
                    preparedStatement.setString(4,Science_Id);
                    preparedStatement.setString(5,English_Id);
                    preparedStatement.setString(6,Hindi_Id);
                    preparedStatement.setString(7, Malayalam_Id);
